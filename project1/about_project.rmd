...
This assignment uses data from the [UC Irvine Machine Learning](http://archive.ics.uci.edu/ml/) Repository, a popular repository for machine learning datasets. In particular, we will be using the "Individual household electric power consumption Data Set" which I have made available on the course web site:
...
![](ref/ExDataCP1Plot1.png)

**Plot 2**

![](ref/ExDataCP1Plot2.png)

**Plot 3**

![](ref/ExDataCP1Plot3.png)


**Plot 4**

![](ref/ExDataCP1Plot4.png)
